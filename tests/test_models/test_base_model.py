...
class TestBaseModel(unittest.TestCase):
    ...
    def test_3_to_dict_no_args(self):
        """Tests to_dict() class method with no arguments."""
        """ Reset any previous storage"""
        self.resetStorage()
        """ Call to_dict() on the class BaseModel, passing in no arguments"""
    ...
    def test_4_instantiation(self):
        ...
        my_model = BaseModel(name="Holberton", my_number=89)
        my_model_dict = my_model.to_dict()
        my_new_model = BaseModel(**my_model_dict)
        assert my_new_model.to_dict() == my_model_dic
    ...
    def test_4_instantiation_dict(self):
        ...
        assert instance.to_dict() == custom_dict
